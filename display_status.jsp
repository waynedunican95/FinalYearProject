...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h2 class="page-header"><c:out value="${user.name}" /></h2>
            </div>
            <div class="col-md-4 col-sm-6">
                <div class="panel panel-default text-center">
                    ...
                    <div class="panel-body">
                        <h4><c:out value="${user.name}" /> Training</h4>
                        <p>
							//Display All Training Information//
						</p>
                        <a href="manager_console.jsp" class="btn btn-primary">Close</a>
                    </div>
                </div>
            </div>
            <div class="col-md-4 col-sm-6">
                <div class="panel panel-default text-center">
                    ...
                    <div class="panel-body">
                        <h4><c:out value="${user.name}" /> Nutrition</h4>
                        <p>
            ...
            <div class="col-md-4 col-sm-6">
                <div class="panel panel-default text-center">
                    ...
                    <div class="panel-body">
                        <h4><c:out value="${user.name}" /> Performance</h4>
                        <p>
							//Display All Perf Information//
						</p>
                        <a href="manager_console.jsp" class="btn btn-primary">Close</a>
                    </div>
                </div>
