            ...
            <div class="col-md-8">
                <div class="panel panel-default">
                    ...
                    <div class="panel-heading">
                        <h4><i class="fa fa-fw fa-bicycle"></i> Performance <span class="label label-primary">New</span></h4>
                    </div>
                    <div class="panel-body">
                    	<center><img src="https://www.gaelicplayers.com/Portals/0/EasyDNNnews/366/366SSC%20Gym%203DLab%2003-min.jpg" width="90%"/></center>
                    	<a href="training.jsp"></a>
                       	<hr>
                       	<form name="performance" id="performanceForm" method="post" action="../PerformanceServlet">	
							<br>
		                    ...
		                    <div class="input-group">
							 	<span class="input-group-addon" id="basic-addon1"><span class="glyphicon glyphicon-time"></span></span>
							  	<input type="text" name="exercise" class="form-control" placeholder="Exercise" aria-describedby="basic-addon1">
							</div>
							<br>
		                    <div class="input-group">
							 	<span class="input-group-addon" id="basic-addon1"><span class="glyphicon glyphicon-time"></span></span>
							  	<input type="text" name="sets" class="form-control" placeholder="Sets" aria-describedby="basic-addon1">
							</div>
							<br>
							<div class="input-group">
							 	<span class="input-group-addon" id="basic-addon1"><span class="glyphicon glyphicon-eye-open"></span></span>
							  	<input type="text" name="reps" class="form-control" placeholder="Reps" aria-describedby="basic-addon1">
							</div>
							<br>
							<div class="input-group">
